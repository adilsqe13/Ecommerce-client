...
export default function AllProducts() {
    ...
    const getWomensAllProducts = async () => {
        const response = await fetch(`${apiUrl}/api/get-womens-all-Products`, {
            method: 'GET',
            headers: {
        ...
        <>
            <div className="container allproducts-container">
                <div className="container heading-all-product">
                    <h2 className='bold'>Women's &nbsp;All &nbsp;Products</h2>
                </div>
